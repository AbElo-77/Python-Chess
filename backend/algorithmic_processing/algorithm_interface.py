...
model = torch.load("backend/algorithmic_processing/models/trained_models/chess_convnext.pt", map_location="cpu")

cnn_model = ChessConvNeXt(num_classes=num_classes) 
cnn_model.load_state_dict(model["model"])
cnn_model.to("cpu") 
cnn_model.eval() 
